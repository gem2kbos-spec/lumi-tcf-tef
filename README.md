...
- 700题规模优化：题干/文章/考点搜索、答案校准状态筛选、每次50题渐进加载和接近底部自动续载
- 两级考点题库：语法、词汇、阅读、听力可继续按细分考点筛选；分别统计真题和全部题目的完成进度
- 六档能力层级（A1–C2）与1–10内部难度；700题按词汇、句法、文本和推断要求逐题评估，不再按题号机械分级
- Word 真题批量导入与对账：保留来源题号、原始顺序、答案校准状态和源文件异常报告
- 700 道导入真题全部可作答；无答案源题经两轮独立判定与分歧仲裁，附中文和法语解析
- 题库精修：700题统一为无重复四选一，227道语法补齐双语解析，残缺填空和可恢复的源文档错位已修正
