export const QUESTION_CATEGORIES = [
  { id: "verb-patterns", type: "grammar", priority: 1, label: "动词搭配与固定结构", description: "动词后接介词、不定式、虚拟式及固定表达", skills: ["collocation", "subjonctif", "discours_indirect"] },
  { id: "verb-tenses", type: "grammar", priority: 2, label: "动词时态与语式", description: "现在、过去、将来、条件式及虚拟式的时态判断", skills: ["passe_compose", "plus_que_parfait", "imparfait", "futur", "conditionnel", "hypothese"] },
  { id: "connectors", type: "grammar", priority: 3, label: "逻辑连接词与从句", description: "原因、结果、目的、让步、对立及句间逻辑", skills: ["connecteurs", "cause", "consequence", "but", "concession"] },
  ...
  { id: "determiners", type: "grammar", priority: 6, label: "冠词与限定词（含数量、tout）", description: "冠词、部分冠词、数量表达、tout及其他限定词", skills: ["articles", "determinants", "quantite", "tout"] },
  { id: "prepositions", type: "grammar", label: "介词与空间时间关系", description: "地点、时间、动词后介词及介词短语", skills: ["prepositions"] },
  { id: "adjectives-adverbs", type: "grammar", label: "形容词、副词与比较", description: "性数配合、副词位置、比较级和 tout 的副词用法", skills: ["adjectives_adverbs"] },
  ...
  { id: "idioms", type: "grammar", label: "惯用语与固定表达", description: "常见俗语、熟语及语境中的固定含义", skills: ["idioms"] },
...
export function categoriesFor(type) {
  return QUESTION_CATEGORIES.filter((item) => item.type === type).sort((a, b) => (a.priority ?? 99) - (b.priority ?? 99));
}
